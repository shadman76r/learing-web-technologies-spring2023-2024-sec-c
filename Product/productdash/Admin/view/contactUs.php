...
<body>
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got any
                issue? Want to send feedback about our features?. If needed let us know
            </p>
            <!-- Contact US Form -->
            <form action="#" class="space-y-8">
                ...
                <div>
                    ...
                    <input type="text" id="subject"
                        ...
                        placeholder="Please let us know how can we help you" required>
                </div>
                <!-- SMS -->
                <div class="sm:col-span-2">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your query</label>
